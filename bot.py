...
# ============================
TELEGRAM_TOKEN = "8141811490:AAH_rL6WIewVdvgDyEY6xEUoIHkVJwn9phQ"
GROQ_API_KEY = "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"
...
def get_recipe(products: str, filter_type: str = "") -> str:
    ...
    if filter_type == "fast":
        ...
        filter_text = "Рецепт должен быть вегетарианским, без мяса и рыбы."
...
async def handle_products(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    menu_buttons = {
        ...
        "⚡ Быстрый рецепт": ("fast", "⚡ Быстрый рецепт за 20 минут!\n\nНапиши продукты:"),
        "🥗 Вегетарианское": ("veg", "🥗 Вегетарианский рецепт!\n\nНапиши продукты:"),
        "🍳 На завтрак": ("breakfast", "🍳 Рецепт для завтрака!\n\nНапиши продукты:"),
        "🍲 На ужин": ("dinner", "🍲 Рецепт для ужина!\n\nНапиши продукты:"),
    }
    ...
    try:
        ...
        keyboard = InlineKeyboardMarkup([
            [InlineKeyboardButton("🔄 Другой рецепт из этих продуктов", callback_data=f"again:{user_text}")]
        ])
